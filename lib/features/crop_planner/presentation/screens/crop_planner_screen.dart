                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('${localization.translate('season')}: ${cropPlan.season}', style: Theme.of(context).textTheme.bodyMedium),
                            Text('${localization.translate('recommendedVariety')}: ${cropPlan.recommendedVariety}', style: Theme.of(context).textTheme.bodyMedium),
                            Text('${localization.translate('daysToMaturity')}: ${cropPlan.daysToMaturity} ${localization.translate('days')}', style: Theme.of(context).textTheme.bodyMedium),
                            const SizedBox(height: 12),
                            Text(localization.translate('sowingWindow'), style: Theme.of(context).textTheme.labelLarge),
                            Text('${DateFormat('d MMM').format(cropPlan.sowingWindowStart)} ${localization.translate('to')} ${DateFormat('d MMM').format(cropPlan.sowingWindowEnd)}', style: Theme.of(context).textTheme.bodyMedium),
                          ],
                        ),
                      ),
                    ),
                    const SizedBox(height: 24),
                    Text(localization.translate('cropSchedule'), style: Theme.of(context).textTheme.headlineSmall),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('${task.daysFromSowing} ${localization.translate('daysAfterSowing')}', style: Theme.of(context).textTheme.bodySmall),
                              ],
                            ),
                          ),
                        );
