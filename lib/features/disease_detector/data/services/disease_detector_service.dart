...
class DiseaseDetectorService {
  static final List<CropDisease> _commonDiseases = [
    ...
    CropDisease(
      ...
      cause: 'Fungal infection by Cochiobolus heterostrophus',
      severity: 'High',
    ...
    CropDisease(
      ...
      cause: 'Fungal infection by Phytophthora infestans',
      severity: 'Critical',
